...
def CONFIGS(config_name):
    if config_name == 'Res-ViT-B_16':
        return get_resvit_b16_config()
    elif config_name == 'Res-ViT-L_16':
        return get_resvit_l16_config()
    elif config_name == 'ViT-B_16':
        return get_b16_config()
    elif config_name == 'ViT-L_16':
